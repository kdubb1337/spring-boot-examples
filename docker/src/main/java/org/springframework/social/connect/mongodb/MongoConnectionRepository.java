...
class MongoConnectionRepository implements ConnectionRepository {
	...
	private static final Logger LOG = LogManager.getLogger(MongoConnectionRepository.class);

	public MongoConnectionRepository(String userId, WebsocketService websocketService, ConnectionService connectionService,
